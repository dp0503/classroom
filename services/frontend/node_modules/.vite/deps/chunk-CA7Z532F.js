...
function useCurrentColorScheme(options) {
  ...
  const modeStorage = React35.useMemo(() => storageManager == null ? void 0 : storageManager({
    key: modeStorageKey,
    storageWindow
  }), [storageManager, modeStorageKey, storageWindow]);
  const lightStorage = React35.useMemo(() => storageManager == null ? void 0 : storageManager({
    key: `${colorSchemeStorageKey}-light`,
    storageWindow
  }), [storageManager, colorSchemeStorageKey, storageWindow]);
  const darkStorage = React35.useMemo(() => storageManager == null ? void 0 : storageManager({
  ...
  const [isClient, setIsClient] = React35.useState(noSsr || !isMultiSchemes);
  React35.useEffect(() => {
    setIsClient(true);
  }, []);
...
@mui/private-theming/index.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-CA7Z532F.js.map
